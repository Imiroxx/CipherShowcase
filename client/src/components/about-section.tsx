...
const AboutSection = () => {
  const faqItems = [
    {
      question: "Безопасен ли ShadowVault?",
      answer: "Да, наша программа использует только международно признанные алгоритмы шифрования, которые невозможно взломать при современном уровне вычислительных мощностей."
    },
    {
    ...
    },
    {
      ...
      answer: "Нет, ShadowVault работает полностью локально на вашем устройстве. Мы не имеем доступа к вашим данным или ключам шифрования."
    },
    {
      question: "Могу ли я использовать программу на нескольких устройствах?",
      answer: "Да, вы можете установить ShadowVault на любое количество устройств без ограничений."
    }
  ];
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
          <div>
            ...
            <p className="text-gray-300 mb-6">
              ShadowVault разработана с целью обеспечить пользователей надежным и простым в использовании инструментом для защиты конфиденциальной информации.
            </p>
            <p className="text-gray-300 mb-6">
